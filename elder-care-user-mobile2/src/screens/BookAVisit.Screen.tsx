...
import { Profile } from '../types/profile'; // Import kiểu Profile nếu cần
...
const BookVisitScreen: React.FC = () => {
    ...
    const [totalPrice, setTotalPrice] = useState<number>(0); // State để lưu tổng tiền, mặc định là 0
    const [isSingleDate, setIsSingleDate] = useState<boolean>(true); // true: "Thuê ngày", false: "Chuỗi ngày"
    const [selectedStartDate, setSelectedStartDate] = useState<Date | null>(null);
    const [selectedEndDate, setSelectedEndDate] = useState<Date | null>(null);
    const [calendarModalVisible, setCalendarModalVisible] = useState(false);
    const [isSelectingStart, setIsSelectingStart] = useState(true); // Để theo dõi chọn ngày bắt đầu hay kết thúc



    // Hàm này sẽ được gọi khi bạn chọn người được chăm sóc từ modal
    const handleCareRecipientSelect = (profile: Profile | undefined) => {
        ...
        if (isSingleDate) {
            ...
            if (isSelectingStart) {
                ...
                if (selectedEndDate && date > selectedEndDate) {
                    setSelectedEndDate(null); // Reset nếu ngày bắt đầu sau ngày kết thúc
                }
                setIsSelectingStart(false); // Chuyển sang chọn ngày kết thúc
            } else {
                setSelectedEndDate(date);
                if (selectedStartDate && date < selectedStartDate) {
                    setSelectedEndDate(null);
                }
                setIsSelectingStart(true); // Reset về chọn ngày bắt đầu cho lần tiếp theo
            }
        }
        setCalendarModalVisible(false); // Đóng modal sau khi chọn
    };
            ...
            <ScrollView style={styles.content}>
                ...
                <View style={styles.section}>
                    ...
                    <TouchableOpacity
                        ...
                        onPress={() => navigation.navigate('AddCareRecipient')} // Chuyển đến màn hình chọn người được chăm sóc
                    >
                        ...
                        <Text style={styles.careRecipientName}>
                            {selectedCareRecipient ? `${selectedCareRecipient.firstName} ${selectedCareRecipient.lastName || ''}` : 'Ông Nguyễn Văn A'}
                        </Text>
                ...
                {/* Services Section */}
                <View style={styles.section}>
                    <Text style={styles.sectionTitle}>Bạn cần dịch vụ hoặc thủ thuật y tế nào?</Text>
                    <TouchableOpacity style={styles.actionButton}>
                        <Text style={styles.actionText}>Chọn dịch vụ hoặc thủ thuật y tế</Text>
                ...
                <View style={styles.section}>
                    ...
                    <View style={styles.dateTypeButtons}>
                        ...
                        <TouchableOpacity
                            ...
                            onPress={() => {
                              ...
                              setSelectedStartDate(null); // reset
                              setSelectedEndDate(null);
                              setIsSelectingStart(true);
                            }}
                        >
                    ...
                    <TouchableOpacity style={styles.actionButton} onPress={openCalendarModal}>
                ...
                <View style={styles.section}>
                    ...
                    <TouchableOpacity style={styles.actionButton}>
                        <Text style={styles.actionText}>Thời gian bắt đầu</Text>
                        <Ionicons name="chevron-forward-outline" size={20} color="#666" />
                        <Text style={styles.actionText}>Thời gian kết thúc </Text>
                        <Ionicons name="chevron-forward-outline" size={20} color="#666" />
                    </TouchableOpacity>
                </View>

                {/* Care Pros Preferences Section */}
                <View style={styles.section}>
                    <Text style={styles.sectionTitle}>Bạn có yêu cầu nào cho người chăm sóc không?</Text>
                    <TouchableOpacity style={styles.actionButton}>
                ...
                <View style={styles.section}>
                    ...
                    <TouchableOpacity style={styles.actionButton}>
                        <Text style={styles.actionText}>Thiết lập phương thức thanh toán</Text>
                        <Ionicons name="chevron-forward-outline" size={20} color="#666" />
                    </TouchableOpacity>
                </View>
            </ScrollView>
